...
def choose_set_of_symbols(index):
    ...
    A dictionary containing various logical symbols used in logic and mathematics, such as symbols for:
        ...
        - Material conditional: represents the logical operation of material conditional, which is a type of conditional statement in logic that is only considered false if the antecedent is true while the consequent is false
